%token KW_LET KW_FUN KW_IN KW_IF KW_THEN KW_ELSE KW_FALSE KW_TRUE KW_REC
...
expr: 
  ...
  | KW_LET KW_REC ID OP_EQ expr KW_IN expr %prec low { Ast.RLetIn ($3, $5, $7) }
  ...
  | KW_LET KW_REC ID id_list OP_EQ expr KW_IN expr %prec low { 
      let rec f = function
        | [] -> failwith "[Err] Wrong grammar"
        | [x] -> Ast.Fun (x, $6)
        | h :: t -> Ast.Fun (h, f t)
